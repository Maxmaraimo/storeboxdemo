...
urlpatterns = [
    ...
    path('platforms/telegram/', views.dashboard_spa_view, name='platforms_telegram'),
    path('platforms/qr/', views.dashboard_spa_view, name='platforms_qr'),
    path('telegram/', views.dashboard_spa_view, name='telegram'),
    ...
    path('api/role-action/', views.role_action_api, name='role_action_api'),
    path('api/courier-action/', views.courier_action_api, name='courier_action_api'),
    ...
    path('settings/staff/roles/', views.dashboard_spa_view, name='settings_staff_roles'),
    path('settings/staff/couriers/', views.dashboard_spa_view, name='settings_staff_couriers'),
    ...
    path('orders/<int:order_id>/', views.dashboard_spa_view, name='order_detail'),
    path('legacy/orders/<int:order_id>/', views.order_detail_view, name='legacy_order_detail'),
