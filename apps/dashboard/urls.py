...
urlpatterns = [
    ...
    path('settings/staff/roles/', views.settings_staff_view, name='settings_staff_roles'),
    path('settings/staff/couriers/', views.settings_staff_view, name='settings_staff_couriers'),
