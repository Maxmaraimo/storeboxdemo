...
urlpatterns = [
    ...
    path('courier/', dashboard_views.courier_panel_view, name='root_courier'),
    path('courier/api/update-order/', dashboard_views.courier_update_order_api, name='root_courier_update_order'),
