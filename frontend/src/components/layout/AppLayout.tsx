...
export const AppLayout: React.FC = () => {
      ...
      <div className="h-screen flex items-center justify-center bg-[#F5F5F7] dark:bg-[#000000]">
        <div className="flex flex-col items-center gap-3">
          ...
          <span className="text-xs font-bold text-slate-500">
            {language === "ru" ? "Загрузка StoreBox..." : language === "en" ? "Loading StoreBox..." : "StoreBox yuklanmoqda..."}
          </span>
        </div>
      </div>
    );
  ...
  return (
    <div className="min-h-screen flex bg-transparent text-neutral-900 dark:text-neutral-100 transition-colors duration-300 p-3 sm:p-4 lg:p-5 gap-3 sm:gap-5">
      <Sidebar />
